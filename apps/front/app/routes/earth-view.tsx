...
export function meta() {
  return [{ title: 'Earth View - Satellite Tracking' }, { name: 'description', content: 'Track satellites in real-time around Earth' }];
}
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <div className="text-center p-6 bg-red-50 rounded-lg">
          <p className="text-red-600">{error instanceof Error ? error.message : 'Failed to fetch satellite data. Please try again later.'}</p>
        </div>
      ) : (
        <div>
