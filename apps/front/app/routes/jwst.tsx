    ...
    queryFn: async () => {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}${
          API_ROUTES.JWST
        }?page=${currentPage}&limit=${limit}&search=${search}`
      );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-slate-500 mb-5">
        ...
        vitae vero quisquam officia deserunt! Perferendis, neque necessitatibus
        nam laboriosam obcaecati vel in doloremque ratione iusto odio, dolore
        consequatur dolores alias.
      </p>
